...
//{
    ...
    else
    {
        ...
        $smarty->assign('linked_goods',get_random_linked_goods($goods['cat_id']));  //随机相关商品
    ...
    $cats_name_arr = $parent_cats ? array_column($parent_cats,'cat_name') : [];
    $smarty->assign('cats_name',  implode(',',$cats_name_arr));
