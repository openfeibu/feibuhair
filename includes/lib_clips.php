...
function add_message($message)
{
    ...
    if (empty($message['msg_content']))
    {
        $GLOBALS['err']->add($GLOBALS['_LANG']['msg_content_empty']);
    ...
    $sql = "INSERT INTO " . $GLOBALS['ecs']->table('feedback') .
            " (msg_id, parent_id,user_id, name, user_name, user_email, msg_title, msg_type, msg_status,  msg_content, msg_time, message_img, order_id, msg_area)".
            " VALUES (NULL, 0, '$message[user_id]', '$message[name]', '$message[user_name]', '$message[user_email]', ".
