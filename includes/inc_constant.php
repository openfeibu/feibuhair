...
/* 外网 */
define('MATRIX_HOST','http://127.0.0.1');//外网申请绑定
define('MATRIX_COMMIT_URL_SYNC','http://127.0.0.1');//矩阵同步API
define('MATRIX_REALTION_URL','http://127.0.0.1/?');//关系绑定API
define('SMS_RESOURCE_URL', 'http://127.0.0.1');//短信平台地址
define('YUNQI_LOGISTIC_URL','http://127.0.0.1/');/* 云起物流地址 */
define('AUTH_USER_URL', '127.0.0.1');/* 授权地址 */
define('YUNQI_ACCOUNT_URL', '127.0.0.1');/* 云起收银地址 */
...
define('OPENAPI_SITE', $_SERVER['HTTP_HOST']);
define('OPENAPI_OAUTH', $_SERVER['HTTP_HOST']);

/* 云起服务地址 */
define('YUNQI_SERVICE_URL',$_SERVER['HTTP_HOST']);
...
/* 版本地址 */
define('VERSION_GBK', 'ECShop_V4.0.0_UTF8_release20180913');
define('VERSION_UTF8', 'ECShop_V4.0.0_UTF8_release20180913');
