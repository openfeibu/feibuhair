...
?>
	...
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      ...
      <img id="captcha" src="captcha.php?<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align: middle;cursor: pointer;" onClick="this.src='captcha.php?'+Math.random()" />
        ...
        <script type="text/javascript">
          var captch = "<?php echo $this->_var['enabled_captcha']; ?>";
          if(captch == 1){
...
<?php if ($this->_var['action'] == 'sms_get_password'): ?>
<div class="usBox">
  <div class="usBox_2 clearfix">
      ...
      <table width="70%" border="0" align="center">
        ...
        <tr id="vcode_rep">
          ...
          <td><input type="text" size="8" id="vcode_input_rep" name="code" class="inputBg" onchange="rep_validate_code(this.value);"/>
            <img src="captcha.php?<?php echo $this->_var['rand']; ?>" id="captcha_rep" alt="captcha" style="vertical-align: middle;cursor: pointer;" onClick="this.src='captcha.php?'+Math.random()" />
...
<?php if ($this->_var['action'] == 'reset_password_rep'): ?>
<div class="usBox">
  <div class="usBox_2 clearfix">
    <form action="user.php" method="post">
      <br />
