...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr>
          ...
          <td><input type="file" name="thumb" id="thumb" size="45"><?php if ($this->_var['cat_info']['thumb'] != ""): ?><a href="javascript:;" onclick="delete_thumb()">删除logo</a><?php endif; ?>
              <br />
              <?php if ($this->_var['cat_info']['thumb']): ?>
              <img src="../data/catthumb/<?php echo $this->_var['cat_info']['thumb']; ?>" />
              <?php endif; ?>
          </td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeFilterAttr');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['notice_style']; ?>"></a><?php echo $this->_var['lang']['filter_attr']; ?>:</td>
        <td>
...
?>
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeGrade');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['notice_style']; ?>"></a><?php echo $this->_var['lang']['grade']; ?>:</td>
        <td>
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeGoodsSN');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['notice_style']; ?>"></a><?php echo $this->_var['lang']['cat_style']; ?>:</td>
        <td>
      ...
      <div class="button-div">
        <input type="submit" class="btn" value="<?php echo $this->_var['lang']['button_submit']; ?>" />
        <input type="reset" class="btn btn-def" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
      </div>
...
{
    if(confirm('确认删除分类图标吗?'))
    {
        window.location.href='category.php?act=drop_thumb&id=<?php echo $this->_var['cat_info']['cat_id']; ?>'
    }
}
//-->
</script>
