...
<table id="page-table" cellspacing="0">
  <tr>
    <td>
      ...
      <input name="date" type="text" id="date" size="10" value='0000-00-00' readonly="readonly" /><button type="button" class="cal" name="selbtn1" id="selbtn1" onclick="return showCalendar('date', '%Y-%m-%d', false, false, 'selbtn1');"><img src="images/cal.png" alt=""></button>
