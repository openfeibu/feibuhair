...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeindex');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['label_attr_index']; ?></td>
        <td>
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeAttrType');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['label_attr_type']; ?></td>
        <td>
          <input type="radio" name="attr_type" value="0" <?php if ($this->_var['attr']['attr_type'] == 0): ?> checked="true" <?php endif; ?> /> <?php echo $this->_var['lang']['attr_type_values']['0']; ?>
          <input type="radio" name="attr_type" value="1" <?php if ($this->_var['attr']['attr_type'] == 1): ?> checked="true" <?php endif; ?> /> <?php echo $this->_var['lang']['attr_type_values']['1']; ?>
          <input type="radio" name="attr_type" value="2" <?php if ($this->_var['attr']['attr_type'] == 2): ?> checked="true" <?php endif; ?> /> <?php echo $this->_var['lang']['attr_type_values']['2']; ?>
