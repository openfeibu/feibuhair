...
?>
  <tr>
    ...
    <td class="first-cell"><span onclick="javascript:listTable.edit(this, 'edit_tag_name', <?php echo $this->_var['tag']['tag_id']; ?>)"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></span></td>
    ...
    <td align="center">
      <span>
      <a href="tag_manage.php?act=edit&amp;id=<?php echo $this->_var['tag']['tag_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><?php echo $this->_var['lang']['edit']; ?></a>
      <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['tag']['tag_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><?php echo $this->_var['lang']['remove']; ?></a></span>
    </td>
  </tr>
  <?php endforeach; else: ?>
