    ...
    <div class="box">
      <div class="box_1">
        <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
          ...
          <?php endif; ?>
          <div style="margin:5px 0; border:1px solid #a1675a;padding:10px 20px; background-color:#e8d1c9;"> <img src="themes/default/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?> </div>
          <br />
          <br />
          ...
          <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
            <table width="100%" border="0" cellpadding="3">
              ...
              <tr>
                ...
                <td><a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/default/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
...
?>
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><?php if ($this->_var['goods']['is_attention']): ?>
...
?>
          ...
          <div class="blank"></div>
          <h5><span><?php echo $this->_var['lang']['divided_into']; ?></span></h5>
          <div class="blank"></div>
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr align="center">
...
//-->
          ...
          <div class="blank"></div>
          <h5><span><?php echo $this->_var['lang']['affiliate_qrcode']; ?></span></h5>
          <div class="blank"></div>
          <div style='display:flex;align-items:flex-end;padding:10px;border:1px solid #ddd;'>
              <img src="<?php echo $this->_var['share_url']; ?>" width='100'>
              <div style='padding-left:10px;'>
                  <div><b><?php echo $this->_var['lang']['affiliate_qrcode_share_text']; ?></b></div>
                  <div><?php echo $this->_var['short_url']; ?></div>
              </div>  
          </div>
...
?>
            <tr align="center">
              ...
              <td bgcolor="#ffffff">javascript <?php echo $this->_var['lang']['affiliate_codetype']; ?><br>
                ...
                [<a href="#" titleTo Clipboard" onClick="Javascript:copyToClipboard(document.getElementById('txt<?php echo $this->_foreach['types']['iteration']; ?>').value);alert('<?php echo $this->_var['lang']['copy_to_clipboard']; ?>');"  class="f6"><?php echo $this->_var['lang']['code_copy']; ?></a>] <br>
                ...
                [<a href="#" titleTo Clipboard" onClick="Javascript:copyToClipboard(document.getElementById('txt<?php echo $this->_foreach['types']['iteration']; ?>_iframe').value);alert('<?php echo $this->_var['lang']['copy_to_clipboard']; ?>');" class="f6"><?php echo $this->_var['lang']['code_copy']; ?></a>] <br />
...
<?php if ($this->_var['val'] != 1 && $this->_var['val'] != 3): ?>[s]<?php echo $this->_var['goods']['market_price']; ?>[/s]<?php endif; ?> [color=red]<?php echo $this->_var['goods']['shop_price']; ?>[/color]</textarea>
                [<a href="#" titleTo Clipboard" onClick="Javascript:copyToClipboard(document.getElementById('txt<?php echo $this->_foreach['types']['iteration']; ?>_ubb').value);alert('<?php echo $this->_var['lang']['copy_to_clipboard']; ?>');"  class="f6"><?php echo $this->_var['lang']['code_copy']; ?></a>]
...
<?php echo $this->_var['shopurl']; ?>goods.php?id=<?php echo $this->_var['goodsid']; ?>&u=<?php echo $this->_var['userid']; ?></textarea>
                [<a href="#" titleTo Clipboard" onClick="Javascript:copyToClipboard(document.getElementById('txt<?php echo $this->_foreach['types']['iteration']; ?>_txt').value);alert('<?php echo $this->_var['lang']['copy_to_clipboard']; ?>');"  class="f6"><?php echo $this->_var['lang']['code_copy']; ?></a>]<?php endif; ?></td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </table>
